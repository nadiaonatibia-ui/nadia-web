...
const cvData: Record<Language, CVData> = {
  es: {
    ...
    education: [
      { institution: 'La Xixa', url: 'https://www.laxixateatre.org/', degree: 'Facilitación de Teatro Fórum Intercultural (13ª edición): "Fomento de competencias emancipadoras, interculturales, sociales y ciudadanas para el aprendizaje a lo largo de la vida". Barcelona, 102 horas lectivas.', year: '2025' },
      { institution: 'PRISCILA — Microcredential for Trainers', url: 'https://www.priscilaproject.eu/', degree: 'Formación de formadores en diseño de programas de aprendizaje para competencias clave (personales, sociales, culturales y de ciudadanía), con el Método Priscila (Teatro del Oprimido, Democracia Profunda, Metodología de Incidentes Críticos, Asambleas Espaciales). Proyecto Erasmus+ KA220-ADU, impartido por La Xixa y ACATHI.', year: '2025' },
      ...
      { institution: 'EDA Escuela de Dirección de Arte', url: 'https://www.direcciondearte.com.ar/', degree: 'Especialización en Dirección de Arte para Cine y Medios Audiovisuales, dictada por Paula Taratuto', year: '2020' },
      { institution: 'Los Pompapetriyasos', url: 'https://pompapetriyasos.com.ar/', degree: 'Formación de Formadores en Teatro Comunitario. Beca del Fondo Nacional de las Artes (FNA), Buenos Aires.', year: '2018' },
  ...
  en: {
    ...
    education: [
      { institution: 'La Xixa', url: 'https://www.laxixateatre.org/', degree: 'Intercultural Forum Theatre Facilitation (13th edition): "Fostering emancipatory, intercultural, social and civic competences for lifelong learning". Barcelona, 102 teaching hours.', year: '2025' },
      { institution: 'PRISCILA — Microcredential for Trainers', url: 'https://www.priscilaproject.eu/', degree: 'Training of Trainers on designing learning programmes for key competences (personal, social, cultural and citizenship), using the Priscila Method (Theatre of the Oppressed, Deep Democracy, Critical Incident Methodology, Spatial Assemblies). Erasmus+ KA220-ADU project, delivered by La Xixa and ACATHI.', year: '2025' },
      ...
      { institution: 'EDA School of Art Direction', url: 'https://www.direcciondearte.com.ar/', degree: 'Specialisation in Art Direction for Film and Audiovisual Media, taught by Paula Taratuto', year: '2020' },
      { institution: 'Los Pompapetriyasos', url: 'https://pompapetriyasos.com.ar/', degree: 'Trainer Training in Community Theatre. Fondo Nacional de las Artes (FNA) scholarship, Buenos Aires.', year: '2018' },
    ...
    expertise: [
      {
        category: 'Program and Project Management',
        items: [
          'Coordination of programmes funded by European frameworks (Erasmus+, Creative Europe, CERV)',
          'Management of international multi-partner consortia',
          'Monitoring, reporting and budget tracking',
          'Project documentation and regulatory compliance',
          'KPI and deliverable tracking',
        ],
      },
      {
        category: 'Cultural Production and Creative Leadership',
        items: [
      ...
      {
        category: 'Community and Participatory Practice',
        items: [
          'Artistic mediation in educational and community settings',
          'Design and facilitation of participatory artistic processes',
          'Arts-based methodologies and transformative arts education',
          'Theatre of the Oppressed and Forum Theatre',
          'Community-based cultural initiatives',
          'Feminist perspective applied to programmes addressing gender, migration and inclusion',
          'Culture and democratic participation',
          'Intercultural and intergenerational dialogue',
        ],
      },
      {
        category: 'Strategic and Operational',
        items: [
          'Operational and budget planning',
          'Supplier and international multidisciplinary team management',
          'Fundraising and diversification of funding sources',
          'Relationship with institutional stakeholders',
        ],
      },
    ],
  ...
  ca: {
    ...
    education: [
      { institution: 'La Xixa', url: 'https://www.laxixateatre.org/', degree: 'Facilitació de Teatre Fòrum Intercultural (13a edició): "Foment de competències emancipadores, interculturals, socials i ciutadanes per a l\'aprenentatge al llarg de la vida". Barcelona, 102 hores lectives.', year: '2025' },
      { institution: 'PRISCILA — Microcredential for Trainers', url: 'https://www.priscilaproject.eu/', degree: "Formació de formadores en el disseny de programes d'aprenentatge per a competències clau (personals, socials, culturals i de ciutadania), amb el Mètode Priscila (Teatre de l'Oprimit, Democràcia Profunda, Metodologia d'Incidents Crítics, Assemblees Espacials). Projecte Erasmus+ KA220-ADU, impartit per La Xixa i ACATHI.", year: '2025' },
      ...
      { institution: "EDA Escola de Direcció d'Art", degree: "Especialització en Direcció d'Art per a Cinema i Mitjans Audiovisuals, impartida per Paula Taratuto", year: '2020' },
      { institution: 'Los Pompapetriyasos', url: 'https://pompapetriyasos.com.ar/', degree: 'Formació de Formadores en Teatre Comunitari. Beca del Fons Nacional de les Arts (FNA), Buenos Aires.', year: '2018' },
    ...
    expertise: [
      {
        ...
        items: [
          'Coordinació de programes finançats per marcs europeus (Erasmus+, Creative Europe, CERV)',
          'Gestió de consorcis multi-partner internacionals',
          'Monitoratge, informes i seguiment pressupostari',
          'Documentació de projectes i compliment normatiu',
          "Seguiment de KPIs i entregables",
        ],
      },
      {
        ...
        items: [
          ...
          'Direcció creativa i fluxos de producció',
      ...
      },
      {
        ...
        items: [
          ...
          'Metodologies arts-based i educació artística transformadora',
          'Teatro de l\'Oprimit i Teatro Fòrum',
          'Iniciatives culturals de base comunitària',
          'Perspectiva feminista aplicada a programes de gènere, migració i inclusió',
          'Cultura i participació democràtica',
          'Diàleg intercultural i intergeneracional',
        ],
      },
      {
        category: 'Estratègic i Operatiu',
        items: [
          'Planificació operativa i pressupostària',
          "Gestió de proveïdors i equips internacionals multidisciplinars",
          "Fundraising i diversificació de fonts de finançament",
          "Relació amb parts interessades institucionals",
        ],
      },
    ],
      ...
      <div className="section-padding">
        <div className="container-wide max-w-4xl mx-auto">
          ...
          <div className="text-center">
            <a href={`/documents/CV_Nadia_Onatibia_${language.toUpperCase()}.pdf`} target="_blank" rel="noopener noreferrer" className="btn bg-vino text-white hover:bg-vino-2 font-medium">
              {d.download}
            </a>
          </div>
        </div>
