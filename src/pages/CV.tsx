...
const cvData: Record<Language, CVData> = {
  ...
  ca: {
    ...
    education: [
      ...
      { institution: 'PRISCILA — Microcredential for Trainers', degree: "Formació de formadores en el disseny de programes d'aprenentatge per a competències clau (personals, socials, culturals i de ciutadania), amb el Mètode Priscila (Teatre de l'Oprimit, Democràcia Profunda, Metodologia d'Incidents Crítics, Assemblees Espacials). Projecte Erasmus+ KA220-ADU, impartit per La Xixa i ACATHI.", year: '2025' },
